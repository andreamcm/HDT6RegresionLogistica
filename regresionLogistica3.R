...
modelo <- glm(VelocidadAdopcion ~ Tipo, data = train[,c("Tipo", "VelocidadAdopcion")], family = binomial(), maxit = 10000)
modelo
plot(modelo)
#summary(modelo)
#test$AdoptionSpeed
...
predi
ayuda <- table(test$VelocidadAdopcion)
ayuda
confusionMatrix(test$VelocidadAdopcion, as.factor(prediction))
